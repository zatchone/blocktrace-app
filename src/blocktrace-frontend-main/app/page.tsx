    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full opacity-80 animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full opacity-80 animate-pulse delay-75"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <footer className="relative z-10 py-8 px-6 lg:px-8 border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center text-gray-500 text-sm">
          ...
          <p className="mt-2">© 2025 BlockTrace. Building transparent supply chains.</p>
        </div>
      </footer>
    </div>
  );
